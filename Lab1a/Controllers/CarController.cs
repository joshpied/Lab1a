...
namespace Lab1a.Controllers
{
    public class CarController : Controller
    {
        ...
        public ActionResult SeedDB()
        {
            ...
            {
                Car car1 = new Car { Make = "Ferrari", Model = "488", Year = 2015, Colour = "Red", VIN="123nice" };
                Car car2 = new Car { Make = "Alfa Romeo", Model = "Giulia", Year = 2019, Colour = "Blue", VIN="456great" };
                _context.Car.AddRange(car1, car2);
